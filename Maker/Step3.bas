...
Sub c1_Result (Success As Boolean, Dir As String, FileName As String)
	If Success Then
		File.Delete( File.DirRootExternal & "/.vDayAppMaker/assets", "h6.jpg")
		File.Copy(Dir, FileName, File.DirRootExternal & "/.vDayAppMaker/assets", "h6.jpg")
		chm1.Visible = True
		
		iv1.RemoveView
		iv1.Bitmap = LoadBitmap(File.DirRootExternal & "/.vDayAppMaker/assets", "h6.jpg")
		iv1.Gravity = Gravity.FILL
		Activity.AddView(iv1,1%x,(lb2.Top+lb2.Height)+2%y,80dip,80dip)
	End If
End Sub
...
Sub c2_Result (Success As Boolean, Dir As String, FileName As String)
	If Success Then
		File.Delete( File.DirRootExternal & "/.vDayAppMaker/assets", "h7.jpg")
		File.Copy(Dir, FileName, File.DirRootExternal & "/.vDayAppMaker/assets", "h7.jpg")
		chm2.Visible = True
		
		iv2.RemoveView
		iv2.Bitmap = LoadBitmap(File.DirRootExternal & "/.vDayAppMaker/assets", "h7.jpg")
		iv2.Gravity = Gravity.FILL
		Activity.AddView(iv2,(chm1.Top+chm1.Width)+6%x,(lb2.Top+lb2.Height)+2%y,80dip,80dip)
	End If
End Sub
...
Sub c3_Result (Success As Boolean, Dir As String, FileName As String)
	If Success Then
		File.Delete( File.DirRootExternal & "/.vDayAppMaker/assets", "h8.jpg")
		File.Copy(Dir, FileName, File.DirRootExternal & "/.vDayAppMaker/assets", "h8.jpg")
		chm3.Visible = True
		
		iv3.RemoveView
		iv3.Bitmap = LoadBitmap(File.DirRootExternal & "/.vDayAppMaker/assets", "h8.jpg")
		iv3.Gravity = Gravity.FILL
		Activity.AddView(iv3,1%x,(iv2.Top+iv2.Height)+2%y,80dip,80dip)
	End If
End Sub
...
Sub c4_Result (Success As Boolean, Dir As String, FileName As String)
	If Success Then
		File.Delete( File.DirRootExternal & "/.vDayAppMaker/assets", "h9.jpg")
		File.Copy(Dir, FileName, File.DirRootExternal & "/.vDayAppMaker/assets", "h9.jpg")
		chm5.Visible = True
		
		iv5.RemoveView
		iv5.Bitmap = LoadBitmap(File.DirRootExternal & "/.vDayAppMaker/assets", "h9.jpg")
		iv5.Gravity = Gravity.FILL
		Activity.AddView(iv5,(chm1.Top+chm1.Width)+6%x,(iv2.Top+iv2.Height)+2%y,80dip,80dip)
	End If
End Sub
...
Sub c5_Result (Success As Boolean, Dir As String, FileName As String)
	If Success Then
		File.Delete( File.DirRootExternal & "/.vDayAppMaker/assets", "h10.jpg")
		File.Copy(Dir, FileName, File.DirRootExternal & "/.vDayAppMaker/assets", "h10.jpg")
		chm6.Visible = True
		
		iv6.RemoveView
		iv6.Gravity = Gravity.FILL
		iv6.Bitmap = LoadBitmap(File.DirRootExternal & "/.vDayAppMaker/assets", "h10.jpg")
		Activity.AddView(iv6,1%x,(iv3.Top+iv3.Height)+2%y,80dip,80dip)
	End If
End Sub
